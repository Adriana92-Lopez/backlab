...
namespace SistemaLabprotecBackEnd.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        [Route("crear")]
        public IActionResult crearRoles(JObject request)//crearRoles();
        {
            dynamic respuesta;
            ...
            using (SqlConnection con = new SqlConnection(_cadenaConexion))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("admin.crud_roles", con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@nombre_rol", request.GetValue("nombre_rol").ToString());
                    ...
                    try
                    {
                        adapter.Fill(setter, "Roles");
                        if (setter.Tables["Roles"] == null)
                        {
                            respuesta = new JObject();
        ...
        [Produces("application/json")]
        [Route("modificar")]
        public IActionResult modificarRoles(JObject request)//ModificarRoles();
        {
            dynamic respuesta;
        ...
        [Produces("application/json")]
        [Route("eliminar")]
        public IActionResult eliminarRoles(JObject request)//eliminarRoles();
        {
            dynamic respuesta;
        ...
        [Produces("application/json")]
        [Route("mostrar")]
        public IActionResult verificarRoles(JObject request)//mostrarRoles();
        {
            dynamic respuesta;
        ...
        [Produces("application/json")]
        [Route("catalogo")]
        public IActionResult catalogoRoles() 
        {
            dynamic respuesta;
